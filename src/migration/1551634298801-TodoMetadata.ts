...
export class TodoMetadata1551634298801 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
      ...
      await queryRunner.query(`ALTER TABLE "todo" ADD CONSTRAINT "FK_d1f431fd7974ef1af9318304fa2" FOREIGN KEY ("metadataId") REFERENCES "todo_metadata"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
